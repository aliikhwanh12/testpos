...
<div class="row gy-4">
    ...
    <div class="col-md-6">
        <div class="card h-100 p-0">
            ...
            <div class="card-body py-16 px-24">
                <p class="mb-16 text-secondary-light fw-normal">You can use the mark tag to <span
                        class="text-warning-main bg-warning-focus px-4">highlight</span> text</p>
                <p class="mb-16 text-secondary-light fw-normal text-decoration-line-through">This is a paragraph. it
                    stands out from regular Delete text </p>
                <p class="mb-16 text-secondary-light fw-normal text-decoration-line-through">This line of text is meant
                    to be treated as no longer accurate.</p>
                <p class="mb-16 text-secondary-light fw-normal text-decoration-underline">This line of text will render
                    as underlined</p>
                <p class="mb-16 text-secondary-light fw-normal text-decoration-underline">This line of text is meant to
                    be treated as an addition to the document.</p>
                <p class="mb-16 text-secondary-light fw-normal">This is a paragraph. it stands out from regular text.
                </p>
    ...
    <div class="col-md-6">
        <div class="card h-100 p-0">
            ...
            <div class="card-body py-16 px-24">
                <p class="mb-16 text-secondary-light fw-normal">Use text-decoration-underline,
                    text-decoration-line-through, or text-decoration-none class to decorate text in components
                    respectively.</p>
                <p class="mb-16 text-primary-light fw-normal text-decoration-underline">This text has a line underneath
                    it.</p>
                <p class="mb-16 text-primary-light fw-normal text-decoration-line-through">This text has a line going
                    through it.</p>
        ...
        <div class="card h-100 p-0">
            ...
            <div class="card-body p-24">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div
                            class="p-16 bg-info-50 radius-8 border-start-width-3-px border-info-main border-top-0 border-end-0 border-bottom-0">
                            <h6 class="text-primary-light text-md mb-8">Custom Blockquote Primary Example</h6>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div
                            class="p-16 bg-danger-50 radius-8 border-start-width-3-px border-danger-main border-top-0 border-end-0 border-bottom-0">
                            <h6 class="text-primary-light text-md mb-8">Custom Blockquote Primary Example</h6>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div
                            class="p-16 bg-neutral-50 radius-8 border-start-width-3-px border-neutral-600 border-top-0 border-end-0 border-bottom-0">
                            <h6 class="text-primary-light text-md mb-8">Custom Blockquote Primary Example</h6>
